    ...
    public class Dfa
    {
        ...
        public static ENfa BuildENfa(List<Exp> exps)
        {
            ...
            for (int i = 0; i < exps.Count; i++) {
                ...
                ENfa enfa = new ENfa();
                exp.BuildENfa(enfa);
                enfa.TailState.LabelIndex = exp.LabelIndex;

                topEnfa.HeadState.EpsilonTransitions.Add(enfa.HeadState);
                enfa.TailState.EpsilonTransitions.Add(enfa.TailState);
            }
            return topEnfa;
        }
        ...
        public static Dfa BuildDfa(ENfa eNfa, int[] _dict)
        {
            Dfa dfa = new Dfa();
        ...
        public static Dictionary<int, HashSet<ENfaState>> MoveAll(IEnumerable<ENfaState> states, int[] _dict)
        {
            Dictionary<int, HashSet<ENfaState>> result = new Dictionary<int, HashSet<ENfaState>>();
